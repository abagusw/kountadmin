...
@section('pageTitle', "Data Goals | $perusahaan->nama")
@push('stylesheets')
@endpush
...
<div class="container-fluid flex-grow-1 container-p-y">
  ...
  <div>Goals</div>
  @can('goals.tambah')
  <a href="{{ route('goals.tambah')}}" class="btn btn-tambah d-block"><span class="ion ion-md-add"></span>&nbsp; Add Goals</a>
  @endcan
  </h4>
        ...
        function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("goals.hapus",[null])}}/' + enc_id,
