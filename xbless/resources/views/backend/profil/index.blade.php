...
@section('pageTitle', "Profil Anda | $perusahaan->nama")
@push('stylesheets')
...
<div class="layout-content">
  <div class="container-fluid flex-grow-1 container-p-y">
    ...
    <h4 class="font-weight-bold py-3 mb-4">Profil Anda</h4>
    @if(session('message'))
      ...
      <div class="card">
        <div class="card-body pb-2">
          <form class="form-horizontal" id="submitData">
            ...
            <img src="{{isset($profil)? $profile : 'https://ui-avatars.com/api/?name='.urlencode($profil->name).'&background=ed4626&color=ffffff&rounded=true'}}" alt="" id="ShowAvatar" class="d-block ui-w-80">
            ...
            <br/>
             <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control mb-1" name="name" id="name" value="{{$profil->name}}">
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="email" class="form-control" name="email" id="email" value="{{isset($profil)? $profil->email : ''}}">
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" name="no_hp" id="no_hp" value="{{isset($profil)? $profil->no_hp : ''}}">
              </div>
            </div>
          ...
          <div class="form-row">
            ...
            <div class="text-right mt-3">
              ...
              <a href="{{route('profil.index')}}"  class="btn btn-default">Kembali</a>
            </div>
          </div>
        </div>
          </form>
