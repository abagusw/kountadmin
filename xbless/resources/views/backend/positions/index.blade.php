...
@section('pageTitle', "Data Positions | $perusahaan->nama")
@push('stylesheets')
@endpush
...
<div class="container-fluid flex-grow-1 container-p-y">
  ...
  <div>Positions</div>
  @can('positions.tambah')
  <a href="{{ route('positions.tambah')}}" class="btn btn-tambah d-block"><span class="ion ion-md-add"></span>&nbsp; Add Positions</a>
  @endcan
  </h4>
        ...
        function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("positions.hapus",[null])}}/' + enc_id,
