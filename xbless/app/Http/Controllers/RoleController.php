    ...
    public function getData(Request $request)
    {
        ...
        foreach ($data as $key=> $result)
        {
          ...
          if($request->user()->can('role.user')){
            $action.='<a href="'.route('role.user',$enc_id).'" class="btn btn-success btn-xs icon-btn md-btn-flat product-tooltip" title="Daftar User" data-original-title="Show"><i class="ion ion-md-contacts"></i></a>&nbsp';
          }
          if($request->user()->can('role.ubah')){
            $action.='<a href="'.route('role.ubah',$enc_id).'" class="btn btn-warning btn-xs icon-btn md-btn-flat product-tooltip" title="Edit"><i class="ion ion-md-create"></i></a>&nbsp;';
          }
